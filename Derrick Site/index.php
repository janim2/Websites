...
<head>
  ...
  <title>Home | SageIT Services</title>
...
<body>
  ...
  <section id="intro" class="clearfix">
    <div class="container">
      <!-- <h2 class="ml2" style="display:inline-block;">hijjjjjjjjjjjjjjjjjj</h2> -->
      <div class="intro-info animated fadeInRightBig">
        <h2>Creativity<br><span>Innovation</span><br>Reliability<br><span>Timely Delivery</span></h2>
        <div>
      ...
      <div class="intro-img">
          <img src="assets/img/logoo.png" alt="" class="img-fluid" style="margin-top:-100px;">
        </div>
  ...
  <main id="main">
    ...
    <section id="about">
      <div class="container">
		...
		<!--wow slider goes here -->
            <!--<img src="assets/img/contact.svg" class="img-fluid" alt="">-->
		<!-- Start WOWSlider.com BODY section -->
		<div id="wowslider-container1">
		<div class="ws_images"><ul>
				<li><a href="http://wowslider.net"><img src="data1/images/desert.jpg" alt="jquery carousel" title="Desert" id="wows1_0"/></a></li>
				<li><img src="data1/images/hydrangeas.jpg" alt="Hydrangeas" title="Hydrangeas" id="wows1_1"/></li>
			</ul></div>
			<div class="ws_bullets"><div>
				<a href="#" title="Desert"><span><img src="data1/tooltips/desert.jpg" alt="Desert"/>1</span></a>
				<a href="#" title="Hydrangeas"><span><img src="data1/tooltips/hydrangeas.jpg" alt="Hydrangeas"/>2</span></a>
    ...
    <section id="services" class="section-bg">
      <div class="container">
        ...
        <header class="section-header">
          <h3 class="ml2">Services</h3>
          <p>Feel free to ask for our professional advice in this areas</p>
        </header>
    ...
    <section id="portfolio" class="clearfix">
      <div class="container">
        ...
        <header class="section-header">
          <h3 class="section-title ml2">Our Portfolio</h3>
        </header>
