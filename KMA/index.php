		...
		<div id="home-slider" class="carousel slide carousel-fade" data-ride="carousel">
			<div class="carousel-inner">
				<div class="item active"> <!-- Change Image -->
					<div class="caption">
						<h1 class="animated fadeInLeftBig"> <strong>KMA Environmental Health Unit</strong></h1>
						<!-- <p class="animated fadeInRightBig">Lorem ipsum, dolor sit amet consectetur adipisicing elit..</p> -->
						<!-- <a data-scroll class="learn-more animated fadeInUpBig" href="#about">Start now</a> -->
					</div>
				</div>
				<div class="item"> <!-- Change Image -->
					<div class="caption">
						<h1 class="animated fadeInLeftBig"><strong>Development <i class='fa fa-deviantart'></i> Sanitation</strong></h1>
						<!-- <p class="animated fadeInRightBig">Lorem ipsum</p> -->
						<!-- <a data-scroll class="learn-more animated fadeInUpBig" href="#about">Start now</a> -->
					</div>
				</div>
			</div>
		...
		<div class="overlay">
			<div class="wrapper-block-skills">
				...
				<div class="element-title">	
					<div class="row">	 		
						<div class="container">	 		
							<h1 class="main-color wow fadeInDown" data-wow-duration="1s" data-wow-delay="300ms">OUR SERVICES</h1>
							<h3 class="white-color wow fadeInUp" data-wow-duration="1s" data-wow-delay="300ms">As an Assembly, we offer Services to help improve Sanitation</h3>
						</div>
					</div>
				</div>
				<!-- End Block Title -->
				...
				<div class="element-title">	
					<div class="row">	 		
						<div class="container">	 		
							...
							<h3 class="white-color wow fadeInUp" data-wow-duration="1s" data-wow-delay="300ms">The work we do come with a lot of responsibilities, and these are the partners that help us make things happen</h3>
						</div>
					</div>
				</div>
				<!-- End Block Title -->
