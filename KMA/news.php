<!DOCTYPE html>
    ...
    <meta charset="utf-8">
    <title>News | KMA Environmental department</title>
							...
							<div class="myport wow fadeInDown" data-wow-duration="1s" data-wow-delay="600ms">
								...
								<?php
									...
									while($getIt = $selectnews_query->fetch()){
										...
										echo "<div class='mix category-1 portfolio' data-myorder='1'>";
												echo "<div class='img-holder'>";
													// echo "<a href='news_info.php?id=1' title='Launching' data-gallery>";

													echo "<a href='news_info.php?id=".$getIt["news_id"]."' title='Launching' data-gallery>";
														...
														echo "<img class='img-responsive' src='"; echo $getIt["news_image"]; echo "' alt='No internet'/>";
															...
															echo "<div class='overlay-content'>";
																echo "<div class='works-overlay-category'>"; echo $getIt["news_caption"]; echo "</div>";
																	...
																	// echo "<div class='works-overlay-icon'><i class='fa fa-image'></i>"; echo "</div>";
															echo "</div>";
													echo "</a>";
												echo "</div>";
										echo "</div>";
