<!DOCTYPE html>
    ...
    <meta charset="utf-8">
    <title>Team | KMA Environmental department</title>
                    ...
                    <div class="row">
                        ...
                        <div id="mynav" class="navbar-collapse collapse">
                            <ul class="nav navbar-nav main-nav-list">
								...
								<li><a href="upload_news.php">Login</a></li>												
                            </ul>
                        </div>		
                    </div>
                </div>
			...
			<div class="element-title">			
				<div class="row">	 		
					...
					<div class="section-title wow fadeInDown" data-wow-duration="1s" data-wow-delay="300ms">			
						...
						<h1 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="300ms">OUR HEADS</h1>
					...
					<div class="wrapper-team">				
								...
								<div class="team-member-holder wow flipInY" data-wow-duration="1s" data-wow-delay="300ms">
									<div class="team-member-image">
										...
										<div class="overlay-content"> 
											...
											<!--<a class="view-profile profile-read-more"  href="profile1.html"   data-single_url="profile1.html">Profile</a>-->	
											<!--The problem here was the name of the second class 'profile-read-more'-->
											<a class="view-profile" href="profile1.html">Profile</a>									
										</div>
									</div>
								...
								<div class="team-member-holder wow flipInY" data-wow-duration="1s" data-wow-delay="500ms">
									<div class="team-member-image">
										...
										<div class="overlay-content"> 
											...
											<a class="view-profile"  href="profile3.html">Profile</a>										
										</div>
									</div>
									<div class="team-member-meta">
										<h4 class="team-member-name"><span class="main-color">Charlotte </span>Asabea <span class="CharlotteaCharlotte-color">Dj</span>an</h4>
										<div class="team-member-role">Environmental Health Analys, Subin-Sub Metro</div>
									</div>
								</div>
							</div>
						</div>
								...
								<div class="team-member-holder wow flipInY" data-wow-duration="1s" data-wow-delay="500ms">
									<div class="team-member-image">
										...
										<div class="overlay-content"> 
											...
											<a class="view-profile"  href="profile4.html">Profile</a>										
										</div>
									</div>
									<div class="team-member-meta">
										<h4 class="team-member-name"><span class="main-color">Fusina </span>Imo<span class="main-color">r</span>o</h4>
										<div class="team-member-role">Environmental Health Analyst, Nhyiaeso</div>
									</div>
								</div>
							</div>
						</div>
						<div class="col-lg-3 col-md-3">
							<div class="team-member">
								<div class="team-member-holder wow flipInY" data-wow-duration="1s" data-wow-delay="500ms">
									<div class="team-member-image">
										<img src="images/team/member-5.jpg" alt="" /> <!-- Change Image -->	
										<div class="team-overlay">
											<div class="img-overlay"></div>
										</div>
										<div class="overlay-content"> 
											...
											<a class="view-profile"  href="profile5.html">Profile</a>										
										</div>
									</div>
									<div class="team-member-meta">
										<h4 class="team-member-name"><span class="main-color">Navelle </span>Jan<span class="main-color">e</span>t</h4>
										<div class="team-member-role">Assistant Environmental Health Analyst, racecourse</div>
									</div>
								</div>
							</div>
						</div>
						<div class="col-lg-3 col-md-3">
							<div class="team-member">
								<div class="team-member-holder wow flipInY" data-wow-duration="1s" data-wow-delay="500ms">
									<div class="team-member-image">
										<img src="images/team/member-6.jpg" alt="" /> <!-- Change Image -->	
										<div class="team-overlay">
											<div class="img-overlay"></div>
										</div>
										<div class="overlay-content"> 
											...
											<a class="view-profile"  href="profile6.html">Profile</a>										
										</div>
									</div>
									<div class="team-member-meta">
										<h4 class="team-member-name"><span class="main-color">Adam</span> Salifu <span class="main-color"> Aba</span>ss</h4>
										<div class="team-member-role">Environmental Health Officer Grade II, Manhyia North</div>
									</div>
								</div>
							</div>
						</div>
						<div class="col-lg-3 col-md-3">
							<div class="team-member">
								<div class="team-member-holder wow flipInY" data-wow-duration="1s" data-wow-delay="800ms">
									<div class="team-member-image">
										<img src="images/team/member-7.jpg" alt="" /> <!-- Change Image -->	
										<div class="team-overlay">
											<div class="img-overlay"></div>
										</div>
										<div class="overlay-content"> 
											...
											<a class="view-profile profile-read-more" href="profile7.html" data-single_url="profile3.html">Profile</a>											
										</div>
									</div>
									<div class="team-member-meta">
						...
						<div class="col-lg-3 col-md-3">
							<div class="team-member">
								<div class="team-member-holder wow flipInY" data-wow-duration="1s" data-wow-delay="1100ms">
									<div class="team-member-image">
										<img src="images/team/member-8.jpg" alt="" /> <!-- Change Image -->	
										<div class="team-overlay">
											<div class="img-overlay"></div>
										</div>
										<div class="overlay-content"> 
											...
											<a class="view-profile profile-read-more" href="profile8.html" data-single_url="profile4.html">Profile</a>										
										</div>
									</div>
									<div class="team-member-meta">
										<h4 class="team-member-name"><span class="main-color">J</span>amie <span class="main-color">D</span>uff</h4>
										<div class="team-member-role">Environmental Health Analyst</div>
									</div>
								</div>
							</div>
						</div>
								...
								<div class="team-member-holder wow flipInY" data-wow-duration="1s" data-wow-delay="500ms">
									<div class="team-member-image">
										...
										<div class="overlay-content"> 
											...
											<a class="view-profile"  href="profile2.html">Profile</a>										
										</div>
									</div>
									<div class="team-member-meta">
										<h4 class="team-member-name"><span class="main-color">Benjamin </span>Atakoraa <span class="main-color">Amanea</span>mpong</h4>
										<div class="team-member-role">Chief Environmental Health Assistant, Manhyia South</div>
									</div>
								</div>
							</div>
						</div>
